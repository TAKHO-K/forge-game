...
13. [D · 결과] 하네스(POWER): 일반 +20→21 1회 ÷ 골드/분 = 21.3분(스테이지 100) · 21.2(500) · 21.1(1,000) · 20.9(5,000 ~ 20,000) - 목표 20 ~ 30분 O. 강화 목표 도달: 일반 +24 = 스테이지 1,000(35.9시간 - 전 +23이 스테이지 20,000) · 상위 1% +30 = 스테이지 5,000(50시간 - 전 +30은 설계 최대 무렵) · 캐주얼 +18(목표) 그대로. 0 → 19강 기대 골드 498,822 → 약 131,000으로 줄었다(+17 ~ +19 비용) - S03(가) ⑦의 기대값(498,822)이 옛 값이라 동반 블록 기대를 갱신해야 한다(F 파트).
