...
> 마지막 갱신: **M1-2 후속 · 2026-09-26** · 직전 보고서 = `docs/phase/M1-2b-report.md` ⑪(그 전 `M1-report.md`) · 스트리밍 = `docs/perf/streaming-settings.md` · 설계 = `docs/design/world-map-m1.md`(세계 지도 · 좌표) · 보스 = `docs/design/boss-br1-2.md` · 패턴 설명 = `docs/design/boss-patterns-explained.md`
...
| 저장 | **SAVE_VERSION 39**(v38 world.portals · peakLevel / v39 titles) · Studio 수동 Play = `Player_<id>_manual`(M1-2 후속 - 실제 프로필은 읽기만) | `server/SaveSystem.lua` |
