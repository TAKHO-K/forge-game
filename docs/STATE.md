...
| D1-2 1 ~ 9 | 1 격차 ≤ 150 불가(×1.25 적용) · **2 캐주얼 1,000 = 39 ~ 45h(목표 재정의 추천)** · **3 반짝이 0.1% + 골드 125** · 4 신발 공속 유물부터 상한 · 5 스킬 계수 옵션 · 6 발자국 체감 · **7 보스 레버 L2(희귀 이상 보장 → 2,075h)** · 8 파티 버스 ×2.7 · 9 토벌 ÷ 사냥 - `D1-2-report.md` ⑧ |
