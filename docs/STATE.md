...
| M1-3 1 ~ 8 | 1 **place 저장**(지형은 place에만) · 2 알 확률 제안값 · 3 물속 대시 불가 · 4 standMaxY 160 유지(충돌 없음 - 활강 단계 재검토) · 5 허브 C-마을도 도감 · 칭호에 셈 · 6 비밀 둥지 자리 클라 노출(보안 단계) · 7 창 열림 중 칩 버튼 딤 · 8 사당 앞 열림(활강 단계) - `M1-3-report.md` ⑨ |
