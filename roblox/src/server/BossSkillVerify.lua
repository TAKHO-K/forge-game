...
local EXPECTED_SECONDS = {
	...
	abyssal_lord = { 76.70, 36.10, 76.70, 36.10, 205.75, 91.25 }, -- 29-4: 범람이 켜졌다(지금 = 설계). 회피 3.5초 + 방전 뒤 3초 x1.3 · P3c A1 해일 리듬(구속 10.22 → 12.23초 - 전 203.35 / 92.80)
	...
	storm_lord = { 72.60, 35.95, 72.60, 35.95, 181.65, 85.80 }, -- 29-4: 장막(낙뢰가 판정)·과충전이 켜졌다(지금 = 설계). 연쇄 번개 → 회오리 · P3c A1 방전 고리 파동 2 + A4 낙뢰 추적(둘째 회차 1.5 → 1.75초 - 전 69.15 · 34.50 · 170.90 / 74.35)
}
