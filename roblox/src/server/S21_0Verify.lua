...
function S21_0Verify.runPure()
	...
	local finiteSamples = {
		...
		{ 10000, "10.0K" }, { 12345, "12.3K" }, { 999999, "1000.0K" }, { 1000000, "1.0M" },
		{ 1500000, "1.5M" }, { 1000000000, "1.0B" }, { 1000000000000, "1.0T" },
		{ 1.9, "1" }, { 10000.9, "10.0K" }, { 250, "250" }, { 88888, "88.9K" },
		{ 1234567890, "1.2B" }, { -5, "-5" }, { 42, "42" }, { 100000, "100.0K" },
	}
	local allSame = true
