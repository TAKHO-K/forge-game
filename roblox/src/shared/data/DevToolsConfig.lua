...
local config = {
	...
	verify = {
		...
		current = {
			...
			-- Play 3(판별 실험): Play 2의 X 블록만 P0(가)(무거운 경제 시뮬) 없이 - 부하 · 타이밍 탓인지 가른다. 넓은 목록은 Play 1 · 2(e1aafa2).
			"P25c(가)", "P25c(나)", "S01(가)", "S01(나)", "S02(가)", "S02(나)", "29-3(가)", "29-3(나)", "S19b(UI)", "S20c(UI)", "S20d(UI)",
		},
	},
}
