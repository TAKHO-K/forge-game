...
local config = {
	...
	verify = {
		...
		-- P2.5a(2026-09-23): 이번 블록 P25a(가)(나) + 동반 실행 - k(1.02) · 강화 · 등급 · 골드 · 생존 앵커가 거의 모든 수치에 들어가 "넓은 쪽으로 포함"(COMMON §3)으로
		-- 옛 블록을 전부 적었다(상시 제외 S04(나)는 exclude가 뺀다). regression은 false 그대로.
		current = {
			...
			"S07(가)", "S08(가)", "S08(나)", "S09(가)", "S09(나)", "S10(가)", "S10(나)", "S11(가)", "S11(나)", "S12(나)",
			"S12b(가)", "S12b(나)", "S13(가)", "S13(나)", "S13b(가)", "S13b(나)", "S14(가)", "S14(나)", "S19b(가)", "S19b(나)",
