...
return {
	tier1 = {
		...
		-- 처치 경험치(13-2). 웹 data/monsters.js가 전 몬스터에 걸쳐 정확히 weaponExp=goldDrop/2
		-- 비율을 썼던 것을 그대로 재사용한 잠정값 - 골드처럼 아직 soft/tank로 안 갈라서
		-- 대푯값 하나만 쓴다. 레벨업 체감 속도(스테이지 진행과 1:1에 가까운가)는 실측 대상이다.
		expReward = 3,
