...
return {
	...
	-- S16 사전 작업 1: 눌러서 이동할 수 있는 잠긴 것(스테이지 선택의 잠긴 구간 칩)의 글씨. lockedIcon(대비 1.5:1)은 "누를 수 없는 비활성"용이라 읽히지 않았다 -
	-- 이 값은 칩 바탕(slot 0.1 투명 · 패널 0.08 투명 위, 세계가 흰색일 때가 최악) 위 명암비 4.5:1 이상(계산은 자체 점검 [S15][UI]가 매 Play 다시 한다).
	lockedText = Color3.fromRGB(138, 141, 148),
