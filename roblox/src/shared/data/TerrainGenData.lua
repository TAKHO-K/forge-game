...
return {
	...
	edgeGuard = { allowR = 2640, basinAllowR = 2945, pushStuds = 8, searchStep = 20, crestSearchStep = 10, landMaxAbove = 30 }, -- M1-4: 땅 허용 반경은 edgeStyles 능선(allowR = 옛 값 · 검사 참고용)
	...
	materialColors = {
		...
		Slate = { 74, 70, 88 }, Pavement = { 90, 86, 104 }, -- 수정 동굴 바닥: 어두운 보랏빛 돌(밝으면 눈처럼 보였다)
		Basalt = { 70, 72, 84 }, -- M1-4: 이 줄이 위 주석 안에 들어가 빠져 있었다(재질 색 미설정 → 엔진 기본색)
		Sand = { 214, 190, 138 }, Sandstone = { 186, 150, 104 },
		Ground = { 112, 102, 90 }, Asphalt = { 84, 84, 92 }, Cobblestone = { 118, 114, 116 }, Salt = { 206, 196, 168 }, -- Salt = T4 길(M1-4)
