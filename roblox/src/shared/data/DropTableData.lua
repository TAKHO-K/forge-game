...
return {
	...
	--   c = min(1, (두 시간의 비) ÷ H) - 한 방이면 1 ÷ H. 이동 시간이 있으면 느리게 잡아도 1보다 조금 작다(드래곤 60초 0.90 · 600초 0.99) - 그 차이가 곧 옛 "이동 시간만큼 높은 tier가
	--   유리했던 몫"이다. 결과 = 같은 사람에게 모든 tier의 시간당 장비 가치가 같다(검증 G1-2(가)). strength = 보정 세기(0 = 끔 · 1 = 전부).
