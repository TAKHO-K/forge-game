...
return {
	titles = {
		primordialChosen = { id = "primordialChosen", name = "태초의 선택", grade = "primordial", condition = "드랍 태초(세계 번호가 붙는 태초)를 처음 얻는다 - 무기 환생 태초는 해당 없음", grantedBy = "server/PrimordialRegistry.onRolled" },
