...
return {
	...
	saveVersion = 42, -- C1 마무리: hints.stealLockSeen(잠긴 몹 말풍선 1회) / v41 M1-3 둥지: world.nests(개인 쿨다운 · 줍기 횟수) · world.nestDex(비밀 둥지 발견 도감) · eggs(알 가방) / v40 world.bossGates(관문 등록) · v39 titles(칭호 - 호기심 대장) · v38 world.portals · peakLevel
